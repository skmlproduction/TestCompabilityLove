...
class ZodiacFlowComposeTest {
    ...
    @Test
    fun zodiacPick_twoSigns_reachesResultActions() {
            ...
            KoinApplication(
                ...
                LoveTestTheme {
                    ...
                    LoveTestNavHost(
                        ...
                        appScope = scope,
                        startDestination = Routes.ZodiacPick,
                    )
                }
            }
        }
        ...
        composeRule.onNodeWithText(signs[0]).performScrollTo().performClick()
        composeRule.onNodeWithText(signs[1]).performScrollTo().performClick()
